 ...
 * @package Graphy
 */
wp_enqueue_script('jquery-3.3.1.min-js', get_template_directory_uri() . '/js/jquery-3.3.1.min.js', array(), false, true);
...
function graphy_scripts() {
	...
	wp_enqueue_style( 'graphy-style', get_stylesheet_uri(), array(), '2.2.2' );
